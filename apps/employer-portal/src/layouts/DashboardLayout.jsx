...
const navLinks = [
  ...
  { to: '/request', label: 'Request Verification', Icon: Send },
  { to: '/history', label: 'History', Icon: History },
  { to: '/request-status', label: 'Request Status', Icon: ListChecks },
];
      ...
      <div className="px-5 py-5 border-t border-gray-200">
        <div className="flex items-center gap-3 rounded-lg bg-gray-50 p-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-gray-500">Employer</p>
          </div>
        </div>
      </div>
    </>
